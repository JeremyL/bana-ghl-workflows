...
This file defines the operational rules that govern all outreach. Every GHL workflow,
automation, and team member action must respect these rules.
...
3. Tag the lead with **"Dispo: DNC"** and log the date opted out
...
1. Immediately move to Dispo: DNC
